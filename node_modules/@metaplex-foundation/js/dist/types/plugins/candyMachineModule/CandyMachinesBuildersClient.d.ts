...
import { DeleteCandyMachineBuilderParams } from './deleteCandyMachine';
import { InsertItemsToCandyMachineBuilderParams } from './insertItemsToCandyMachine';
import { MintCandyMachineBuilderParams } from './mintCandyMachine';
...
export declare class CandyMachinesBuildersClient {
    ...
    mint(input: MintCandyMachineBuilderParams): Promise<import("../..").TransactionBuilder<import("./mintCandyMachine").MintCandyMachineBuilderContext>>;
