...
export declare const toAuctionHouse: (auctionHouseAccount: AuctionHouseAccount, treasuryMint: Mint, auctioneerAccount?: Readonly<{
    publicKey: PublicKey;
    executable: boolean;
    owner: PublicKey;
    lamports: number;
    data: import("@metaplex-foundation/mpl-auction-house").Auctioneer;
    rentEpoch?: number | undefined;
}> | null | undefined) => AuctionHouse;
