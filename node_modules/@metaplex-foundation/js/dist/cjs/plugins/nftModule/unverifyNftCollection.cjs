...
function _unverifyNftCollectionClient(nftOrSft, input = {}) {
  return new Task.Task(async scope => {
    ...
    if (!collectionMintAddress) {
      throw new errors.ParentCollectionMissingError(mintAddress, 'unverifyCollection');
    }
...
exports._unverifyNftCollectionBuildersClient = _unverifyNftCollectionBuildersClient;
exports._unverifyNftCollectionClient = _unverifyNftCollectionClient;
