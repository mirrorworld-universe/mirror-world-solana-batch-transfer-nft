...
function _printNewEditionClient(originalNft, input = {}) {
  return new Task.Task(async scope => {
    const originalMint = helpers.toMintAddress(originalNft);
...
exports._printNewEditionBuildersClient = _printNewEditionBuildersClient;
exports._printNewEditionClient = _printNewEditionClient;
