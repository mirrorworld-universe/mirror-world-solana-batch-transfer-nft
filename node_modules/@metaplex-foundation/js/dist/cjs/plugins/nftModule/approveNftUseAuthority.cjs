...
function _approveNftUseAuthorityClient(nftOrSft, user, input = {}) {
...
function _approveNftUseAuthorityBuildersClient(input) {
...
exports._approveNftUseAuthorityBuildersClient = _approveNftUseAuthorityBuildersClient;
exports._approveNftUseAuthorityClient = _approveNftUseAuthorityClient;
