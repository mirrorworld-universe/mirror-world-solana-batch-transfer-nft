...
/** @internal */
function _approveTokenDelegateAuthorityClient(input) {
  return this.metaplex.operations().getTask(approveTokenDelegateAuthorityOperation(input));
}
/** @internal */

function _approveTokenDelegateAuthorityBuildersClient(input) {
...
export { _approveTokenDelegateAuthorityBuildersClient, _approveTokenDelegateAuthorityClient, approveTokenDelegateAuthorityBuilder, approveTokenDelegateAuthorityOperation, approveTokenDelegateAuthorityOperationHandler };
