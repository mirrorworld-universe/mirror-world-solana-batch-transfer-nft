...
/** @internal */
function _uploadMetadataClient(input) {
...
export { _uploadMetadataClient, getAssetsFromJsonMetadata, replaceAssetsWithUris, uploadMetadataOperation, uploadMetadataOperationHandler };
