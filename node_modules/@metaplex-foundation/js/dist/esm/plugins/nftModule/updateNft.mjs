...
/** @internal */
function _updateNftClient(nftOrSft, input) {
...
function _updateNftBuildersClient(input) {
...
const updateNftBuilder = (metaplex, params) => {
  ...
  return TransactionBuilder.make() // Unverify current collection before overriding it.
...
const toInstructionData = (nftOrSft, input = {}) => {
  ...
  return {
    updateAuthority: (_input$newUpdateAutho = input.newUpdateAuthority) !== null && _input$newUpdateAutho !== void 0 ? _input$newUpdateAutho : nftOrSft.updateAuthorityAddress,
    primarySaleHappened: (_input$primarySaleHap = input.primarySaleHappened) !== null && _input$primarySaleHap !== void 0 ? _input$primarySaleHap : nftOrSft.primarySaleHappened,
    isMutable: (_input$isMutable = input.isMutable) !== null && _input$isMutable !== void 0 ? _input$isMutable : nftOrSft.isMutable,
    data: {
...
export { _updateNftBuildersClient, _updateNftClient, updateNftBuilder, updateNftOperation, updateNftOperationHandler };
