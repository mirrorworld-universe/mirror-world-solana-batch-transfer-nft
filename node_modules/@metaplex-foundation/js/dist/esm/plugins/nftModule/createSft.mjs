...
function _createSftClient(input) {
...
function _createSftBuildersClient(input) {
...
const createMintAndTokenForSftBuilder = async (metaplex, params, useNewMint) => {
  ...
  const associatedTokenAddress = params.tokenOwner ? findAssociatedTokenAccountPda(mintAddress, params.tokenOwner) : null;
...
export { _createSftBuildersClient, _createSftClient, createSftBuilder, createSftOperation, createSftOperationHandler };
//# sourceMappingURL=createSft.mjs.map
